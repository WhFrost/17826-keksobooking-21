...
// window.data.maxRandomR_COUNT = 8;
...
//   let userId = window.utils.nextRandomUserId(window.data.usersId);
//   let locationX = window.utils.random(0, window.data.locationX);
//   let locationY = window.utils.random(0, window.data.locationY);
//   return {
//     author: {
...
//       price: window.utils.random(0, window.data.maxRandom),
//       type: window.utils.randomElement(window.data.offerType),
//       rooms: window.utils.random(0, window.data.maxRandom),
//       guests: window.utils.random(0, window.data.maxRandom),
//       checkin: window.utils.randomElement(window.data.offerCheckIn),
//       checkout: window.utils.randomElement(window.data.offerCheckOut),
//       features: window.utils.randomArr(window.data.offerFeatures),
//       description: `Описание`,
//       photos: window.utils.randomArr(window.data.offerPhotos)
//     },
//     location: {
//       x: locationX,
//       y: locationY
...
//   window.data.map.insertBefore(card, FILTERS_CONTAINER);
